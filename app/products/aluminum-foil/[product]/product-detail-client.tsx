...
export default function ProductDetailClient({ product }: ProductDetailClientProps) {
  ...
  const categoryName = product.categories?.[0]?.name_i18n[language] || product.categories?.[0]?.name_i18n['en'] || 'Aluminum Foil';

  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader 
        title={productName}
        description={productDescription || `High-quality aluminum foil product - ${productName}`}
      />
